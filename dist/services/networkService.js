            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, networks.map(function (network) {
                            return __assign(__assign({}, network), { password: (0, criptrUtils_1.decrypt)(network.password) });
                        })];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    network = _a.sent();
                    if (!network)
                        throw (0, errorUtils_1.notFoundError)("Network doesn't exist");
                    return [2 /*return*/, __assign(__assign({}, network), { password: (0, criptrUtils_1.decrypt)(network.password) })];
            }
        });
    });
}
function createNetwork(user, network) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    networkInfos = __assign(__assign({}, network), { password: (0, criptrUtils_1.encrypt)(network.password) });
