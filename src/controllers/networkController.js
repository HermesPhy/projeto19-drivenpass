...
var networkService_js_1 = require("../services/networkService.js");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, networkService_js_1["default"].getAllNetworks(user.id)];
                case 1:
                    networks = _a.sent();
                    res.send(networks);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, networkService_js_1["default"].getNetwork(user.id, networkId)];
                case 1:
                    network = _a.sent();
                    res.send(network);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = res.locals.user;
                    network = req.body;
                    return [4 /*yield*/, networkService_js_1["default"].createNetwork(user, network)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    user = res.locals.user;
                    return [4 /*yield*/, networkService_js_1["default"].deleteNetwork(user, networkId)];
                case 1:
                    _a.sent();
                    res.sendStatus(200);
                    return [2 /*return*/];
